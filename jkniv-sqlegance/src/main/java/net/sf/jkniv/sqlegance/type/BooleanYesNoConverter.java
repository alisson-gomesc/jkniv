...
public class BooleanYesNoConverter implements Convertible<Boolean, String>
{
    private final static int[] TYPES = {Types.CHAR, Types.VARCHAR, Types.NCHAR, Types.NVARCHAR};
    private final static String FALSE = "N", TRUE = "Y";
    public final static BooleanYesNoConverter INSTANCE = new BooleanYesNoConverter();
