...
public class BooleanTrueFalseConverter implements Convertible<Boolean, String>
{
    private final static int[] TYPES = {Types.CHAR, Types.VARCHAR, Types.NCHAR, Types.NVARCHAR};
    private final static String FALSE = "F", TRUE = "T";
    public final static BooleanTrueFalseConverter INSTANCE = new BooleanTrueFalseConverter();
