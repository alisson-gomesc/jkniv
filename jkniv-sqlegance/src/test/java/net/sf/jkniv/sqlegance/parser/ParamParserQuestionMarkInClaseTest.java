...
//    String sqlExpected = "select id, name from Roles where id = ?   and name = ?            and dt = to_date(?  ,'YYYY-MM-DD HH24:MI:SS')";
    ...
    @Test
    public void whenParserParamsUseQuestionMarkUsingSimpleINclause()
    {
        String[] params = {"A","B","C"};
    ...
    @Test
    public void whenParserParamsUseQuestionMarkUsingDoubleINclause()
    {
        String[] params = {"A","B","C"};
    ...
    @Test
    public void whenParserParamsUseQuestionMarkINclauseWithQuestion()
    {
        String[] params = {"A","B","C"};
