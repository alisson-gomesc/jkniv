...
public class ConvertException extends RepositoryException
{
    private static final long serialVersionUID = -8466499968171041625L;

    /**
     * Constructor for ConvertException without message detail
     */
