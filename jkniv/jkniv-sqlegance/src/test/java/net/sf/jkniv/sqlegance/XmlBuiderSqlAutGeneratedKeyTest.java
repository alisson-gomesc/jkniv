...
public class XmlBuiderSqlAutGeneratedKeyTest
{
    ...
    public void whenBuildInsertWithDefaultAutoGeneratedKey()
    {
        ...
        assertThat(sql, instanceOf(InsertTag.class));
        Insertable tag  = (Insertable) sql;
        assertThat(tag.isAutoGenerateKey(), is(true));
        assertThat(tag.getAutoGeneratedKeyTag(), notNullValue());
        assertThat(tag.getAutoGeneratedKeyTag().getStrategy(), is(KeyGeneratorType.AUTO));
        assertThat(tag.getAutoGeneratedKeyTag().getColumns(), is(""));
        assertThat("Properties cannot be null or empty when use auto generate key", 
                   tag.getAutoGeneratedKeyTag().getProperties(), not(isEmptyOrNullString()));
        assertThat(tag.getAutoGeneratedKeyTag().getText(), is(""));
    ...
    public void whenBuildInsertWithSequenceGeneratedKey()
    {
        ...
        assertThat(tag.isAutoGenerateKey(), is(true));
        assertThat(tag.getAutoGeneratedKeyTag(), notNullValue());
        assertThat(tag.getAutoGeneratedKeyTag().getStrategy(), is(KeyGeneratorType.SEQUENCE));
        assertThat(tag.getAutoGeneratedKeyTag().getColumns(), is(""));
        assertThat(tag.getAutoGeneratedKeyTag().getText(), is(""));
        assertThat("Properties cannot be null or empty when use auto generate key", 
                tag.getAutoGeneratedKeyTag().getProperties(), not(isEmptyOrNullString()));
    ...
    public void whenBuildInsertSequenceGeneratedKeyWithKey()
    {
        ...
        assertThat(tag.getAutoGeneratedKeyTag().getStrategy(), is(KeyGeneratorType.SEQUENCE));
        assertThat(tag.getAutoGeneratedKeyTag().getColumns(), is(""));
        assertThat(tag.getAutoGeneratedKeyTag().getText(), is("select myschema.mysequence.nextval from dual"));
        assertThat("Properties cannot be null or empty when use auto generate key", 
                tag.getAutoGeneratedKeyTag().getProperties(), not(isEmptyOrNullString()));
        assertThat(sql.getParamParser().getType(), is(ParamMarkType.HASH));
    }
    ...
    public void whenBuildInsertWithoutNoGeneratedKey()
    {
        ...
        assertThat(tag.getAutoGeneratedKeyTag(), nullValue());
        assertThat(sql.getParamParser().getType(), is(ParamMarkType.HASH));
    }
