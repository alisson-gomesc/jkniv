...
public class RestFulReportResources extends BaseResource
{
    ...
    @Path("view/{q}/{j}/{t}")
    public Response view(@PathParam("q") String q, @PathParam("t") String t, @PathParam("j") String j, @Context UriInfo ui) throws JRException {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("view/{q}/{m}/{j}/{t}")
    public Response view(@PathParam("q") String q, @PathParam("t") String t, @PathParam("j") String j, @PathParam("m") String m, @Context UriInfo ui) throws JRException {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("show/{q}/{t}")
    public Response show(@PathParam("q") String q, @PathParam("t") String t, @PathParam("j") String j, @Context UriInfo ui) {
        Queryable queryable = buildQueryable(q, ui);
        List<?>  resources = getRepository().list(queryable);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("show/{q}/{m}/{t}")
    public Response show(@PathParam("q") String q, @PathParam("t") String t, @PathParam("j") String j, @PathParam("m") String m, @Context UriInfo ui) {
        Class<?> clazz = modelTypes.getType(m);
        Queryable queryable = buildQueryable(q, clazz, ui);
        List<?>  resources = getRepository().list(queryable);
        return buildSimpleResponse(resources);
