...
public class BaseResource
{
    ...
    public BaseResource()
    {
        ...
        LOG.trace("Creating new repository for sql context ["+sqlContextName+"]");
        if (sqlContext == null)
        {
            sqlContext = SqlContextFactory.newInstance(sqlContextName);
...
//    }
    ...
    protected Repository getRepository()
    {
        ...
        //return new RepositoryJpa("clsiv-repo");
