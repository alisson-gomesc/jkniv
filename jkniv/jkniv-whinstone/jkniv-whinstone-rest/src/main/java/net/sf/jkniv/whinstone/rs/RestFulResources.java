...
public class RestFulResources extends BaseResource
{
    ...
    @GET
    @Path("list/{q}")
    public Response list(@PathParam("q") String q, @Context UriInfo ui) {
        Queryable queryable = buildQueryable(q, ui);
        List<?>  resources = getRepository().list(queryable);
    ...
    @GET
    @Path("list/{q}/{m}")
    public Response list(@PathParam("q") String q, @PathParam("m") String m, @Context UriInfo ui) {
    ...
    @GET
    @Path("list/{q}/{m}/{t}")
    public Response list(@PathParam("q") String q, @PathParam("m") String m, @PathParam("t") String t, @Context UriInfo ui) {
        Class<?> clazz = modelTypes.getType(m);
    ...
    @GET
    @Path("get/{q}")
    public Response get(@PathParam("q") String q, @Context UriInfo ui) {
        Queryable queryable = buildQueryable(q, ui);
        Object resource = getRepository().get(queryable);
    ...
    @GET
    @Path("get/{q}/{m}")
    public Response get(@PathParam("q") String q, @PathParam("m") String m, @Context UriInfo ui) {
        Class<?> clazz = modelTypes.getType(m);
        Class<?> clazzTransform = transformers.getType(m);
        Queryable queryable = null;
        TransformReturn<?> transform = null;
    ...
    @POST
    @Path("add/{q}")
    public Response add(@PathParam("q") String q, @Context UriInfo ui) {
        Queryable queryable = buildQueryable(q, ui);
        Integer rowsAffected = getRepository().add(queryable);
    ...
    @POST
    @Path("add/{q}/{m}")
    public Response add(@PathParam("q") String q, @PathParam("m") String m, @Context UriInfo ui) {
        Class<?> clazz = modelTypes.getType(m);
        Queryable queryable = buildQueryable(q, clazz, ui);
        Object object = getRepository().add(queryable.getParams());
    ...
    @PUT
    @Path("update/{q}")
    public Response update(@PathParam("q") String q, @Context UriInfo ui, String body) throws JsonParseException, JsonMappingException, IOException 
    {
    ...
    @PUT
    @Path("update/{q}/{m}")
    public Response update(@PathParam("q") String q, @PathParam("m") String m, @Context UriInfo ui, String body)  
    ...
    */
    ...
    @DELETE
    @Path("remove/{q}")
    public Response remove(@PathParam("q") String q, @Context UriInfo ui) 
    {
        Queryable queryable = buildQueryable(q, ui);
        Integer rowsAffected = getRepository().remove(queryable);
        return buildSimpleResponse(rowsAffected);
        //return buildSimpleResponse(rowsAffected, queryable);// FIXME HTTP status
    }
    ...
    @DELETE
    @Path("remove/{q}/{m}")
    public Response remove(@PathParam("q") String q, @PathParam("m") String m, @Context UriInfo ui) 
    {
        Class<?> clazz = modelTypes.getType(m);
        Queryable queryable = buildQueryable(q, clazz, ui);
