...
class PositionalCollectionParamsOld extends AbstractParam implements AutoBindParams
{
    private StatementAdapterOld stmtAdapter;
    private Object                 params;
    private String queryName;
    
    public PositionalCollectionParamsOld(StatementAdapterOld stmtAdapter, Object params, String queryName)
    {
        super();
