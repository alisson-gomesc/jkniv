...
public class SqlDeleteMockitoTest
{
    ...
    @Test
    public void whenDeletingEntity()
    {
        JdbcCommandMock jdbcMock = new JdbcCommandMock(FlatBook.class);
        Repository repository = jdbcMock.withDeletable().getRepository();
        FlatBook book = new FlatBook();
        int rows = repository.remove(book);
    ...
    public void whenBulkArrayMap() throws SQLException
    {
        ...
        int rows = repository.remove(QueryFactory.ofArray("delete", books));
