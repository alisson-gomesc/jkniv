 ...
 */
package net.sf.jkniv.whinstone.jdbc.database.postgresql;
...
public class PostgreSqlDialectTest extends SqlDialectAbstractTest
{
    ...
    private static final String SQL_SELECT_RESULT = "select name from author LIMIT 50 OFFSET 10";
    /** select distinct name from author LIMIT 50 OFFSET 10 for update */
    private static final String SQL_SELECT_RESULT_SENSITIVE = "select distinct name from author LIMIT 50 OFFSET 10 for update";
    /** select distinct name from author LIMIT 50 OFFSET 10 */
    private static final String SQL_SELECT_RESULT_DISTINCT = "select distinct name from author LIMIT 50 OFFSET 10";
    /** select name from author LIMIT 50 OFFSET 10 for update */
    private static final String SQL_SELECT_RESULT_FOR_UPDATE= "select name from author LIMIT 50 OFFSET 10 for update";

    private Queryable newQueryable(Queryable q, Sql s)
    {
        SqlDialect d = new PostgreSqlDialect();
        s.bind(d);
        q.bind(s);
        return q;
    }
