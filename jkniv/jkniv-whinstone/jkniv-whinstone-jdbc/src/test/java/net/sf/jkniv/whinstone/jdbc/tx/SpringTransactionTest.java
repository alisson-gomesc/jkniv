...
public class SpringTransactionTest extends BaseJdbc
{
    @Autowired
    Repository repositorySpring;
    Queryable q;
    ...
    public void tearDown()
    {
        ...
        int result = repositorySpring.list(q).size();
    ...
    @Transactional
    @Commit
    public void whenRunSpringDataSourceTransaction()
    {
        System.out.println("whenRunSpringDataSourceTransaction->" + Thread.currentThread().getName());
