 ...
 * @since 0.6.0
 */
public class AddJdbcCommand extends JdbcAbstractCommand
{
    private final Insertable      isql;
    
    public AddJdbcCommand(Queryable queryable, PreparedStatementStrategy stmtStrategy, Connection conn)
    {
 ...
 * @since 0.6.0
 */
public class AddJdbcCommand extends AbstractJdbcCommand
{
    //private final Insertable      isql;
    
    public AddJdbcCommand(Queryable queryable, Connection conn)
    {
        super(queryable, conn);
        //this.isql = queryable.getDynamicSql().asInsertable();
    }

    public AddJdbcCommand(StatementAdapter stmt, Queryable queryable, Connection conn)
    {
