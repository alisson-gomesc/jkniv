 ...
 * @since 0.6.0
 */
public class Jpa2ConnectionAdapter implements ConnectionAdapter
{
    ...
    public Jpa2ConnectionAdapter(String contextName, HandleableException handlerException)
    {
    ...
    {
        return "Jpa2ConnectionAdapter [session=" + session + ", cluster=" + cluster + "]";
    }
}
