...
public class CouchdbCallbackTest extends BaseJdbc
{
    @Test
    public void whenInvokeCallbackMethodForAddOperation()
    {
    ...
    @Test
    public void whenInvokeCallbackMethodForSelectOperation()
    {
        Repository repositoryDb = getRepository();
        StatsCallback model = new StatsCallback();
    ...
    @Test
    public void whenInvokeCallbackMethodForUpdateOperation()
    {
        Repository repositoryDb = getRepository();
        StatsCallback model = new StatsCallback();
        model.setName("Callback stuff");
    ...
    @Test
    public void whenInvokeCallbackMethodForRemoveOperation()
    {
        Repository repositoryDb = getRepository();
        StatsCallback model = new StatsCallback();
        model.setName("Callback stuff");
