...
abstract class AbstractResultRow<T> //implements ResultRow
{
    ...
    protected void setValueOf(JdbcColumn<ResultSet> column, ResultSet rs, ObjectProxy<T> proxy) throws SQLException
    {
        ...
        else
        {
            ...
            {
                Convertible<Object, Object> convertible = getConverter(column.getPropertyAccess(), proxy);
     ...
     */
    protected Convertible<Object, Object> getConverter(PropertyAccess access, ObjectProxy proxy)
    {
