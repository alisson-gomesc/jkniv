...
public class Cat extends Animal
{
    ...
    //@PostCallBack(scope ={ CallbackScope.SELECT, CallbackScope.ADD, CallbackScope.UPDATE, CallbackScope.REMOVE, CallbackScope.EXCEPTION })
    public void postException()
    {
        System.out.println("Cat post-exception");
    }
    
    //@PostCallBack(scope ={ CallbackScope.ADD, CallbackScope.UPDATE, CallbackScope.REMOVE, CallbackScope.COMMIT })
