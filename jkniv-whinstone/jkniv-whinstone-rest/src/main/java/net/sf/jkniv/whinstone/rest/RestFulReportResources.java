...
public class RestFulReportResources extends BaseResource
{
     ...
     * @throws JRException Report design exception
     */
    @GET
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @Path("view/{q}/{j}/{t}")
    public Response view(@PathParam("context") String ctx, @PathParam("q") String q, @PathParam("t") String t,
            @PathParam("j") String j, @Context UriInfo ui) throws JRException
    {
    ...
    @Path("view/{q}/{m}/{j}/{t}")
    public Response view(@PathParam("context") String ctx, @PathParam("q") String q, @PathParam("t") String t,
            @PathParam("j") String j, @PathParam("m") String m, @Context UriInfo ui) throws JRException
    {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("show/{q}/{t}")
    public Response show(@PathParam("context") String ctx, @PathParam("q") String q, @PathParam("t") String t,
            @PathParam("j") String j, @Context UriInfo ui)
    {
        Queryable queryable = buildQueryable(q, ui);
        List<?> resources = getRepository(ctx).list(queryable);
    ...
    @Path("show/{q}/{m}/{t}")
    public Response show(@PathParam("context") String ctx, @PathParam("q") String q, @PathParam("t") String t,
            @PathParam("j") String j, @PathParam("m") String m, @Context UriInfo ui)
    {
        Class<?> clazz = modelTypes.getType(m);
        Queryable queryable = buildQueryable(q, clazz, ui);
        List<?> resources = getRepository(ctx).list(queryable);
