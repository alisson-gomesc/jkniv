...
public class ApacheHttpClientTest
{
    ...
    public void whenAuthRequestGetRecord()
    {
        ...
        RequestParams header = new RequestParams("useraccess");
        String uri = "http://127.0.0.1:5984/useraccess/1";
    ...
    {
        String uri = "http://admin:admin@127.0.0.1:5984/useraccess/_security";
