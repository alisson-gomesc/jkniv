...
public class CassandraSequenceGeneratedKey implements AutoKey<Object>
{
    ...
    public CassandraSequenceGeneratedKey(Insertable isql, Session session, HandleableException handlerException)
    {
        ...
        //{
            ...
            com.datastax.driver.core.ResultSet generatedKeys= session.execute(statement);
