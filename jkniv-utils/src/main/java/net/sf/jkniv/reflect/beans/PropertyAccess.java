...
public class PropertyAccess
{
    ...
    public void resolve(Class<?> targetClass)
    {
        ...
        if (targetClass != null)
        {
            ...
            handler.mute(NoSuchMethodException.class)
            ...
            this.readMethod = new MethodReflect(handler).getMethod(this.fieldName, this.targetClass);
            this.writerMethod = new MethodReflect(handler).getMethod(this.fieldName, this.targetClass, CapitalNameFactory.getInstanceOfSetter());
        }
    }
